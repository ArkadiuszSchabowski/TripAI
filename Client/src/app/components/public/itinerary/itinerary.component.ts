...
export class ItineraryComponent {
  ...
  tripIntro: "Discover the industrial charm and modern energy of Katowice on this delightful 6-day cultural escape from Berlin.",
  closingFeeling: "We hope your journey to Katowice leaves you with wonderful memories of vibrant city life, rich history, and the unique architecture of Upper Silesia.",
  information: {
    originCity: "Berlin",
  ...
  dailyPlan: [
    {
      ...
      morningWhy: "A convenient mid-day departure allowing time to reach the airport comfortably.",
      ...
      tonightWhy: "Ease into the city atmosphere with some local Polish cuisine."
    },
    {
      dayNumber: 2,
      morningPlan: "Explore the Cultural Zone",
      morningWhy: "Visit the iconic Silesian Museum located on the grounds of a former coal mine.",
    ...
    },
    {
      ...
      morningWhy: "A unique historical worker's estate with charming red-brick architecture.",
      afternoonPlan: "Cafe hopping in the district",
      afternoonWhy: "Experience the authentic local lifestyle in this heritage area.",
    ...
    },
    {
      ...
      morningWhy: "One of the largest city parks in Europe, perfect for a relaxing morning stroll.",
      afternoonPlan: "Silesian Planetarium",
      afternoonWhy: "Discover science and astronomy in a beautifully modernized facility.",
    ...
    },
    {
      ...
      morningWhy: "Explore the vibrant retail scene and local art galleries in the center.",
      afternoonPlan: "Modern art gallery exhibition",
      afternoonWhy: "Immerse yourselves in the local contemporary creative scene.",
    ...
    },
    {
      ...
      morningWhy: "Enjoy a final coffee and souvenirs shopping before departure.",
      afternoonPlan: "Transfer to Katowice Airport",
      afternoonWhy: "Ensuring arrival at the airport in time for the 17:48 flight.",
  ...
  constructor(private router: Router, private tripStateService: TripStateService) {}
